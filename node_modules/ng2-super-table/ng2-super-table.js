(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ng2SuperTable"] = factory(require("@angular/core"));
	else
		root["ng2SuperTable"] = factory(root["ng"]["core"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var superTable_component_1 = __webpack_require__(1);
	var superTable_component_2 = __webpack_require__(1);
	exports.SuperTable = superTable_component_2.SuperTable;
	var superTableSorters_1 = __webpack_require__(33);
	exports.superTableSorters = superTableSorters_1.superTableSorters;
	var superTableFilters_1 = __webpack_require__(34);
	exports.superTableFilters = superTableFilters_1.superTableFilters;
	var superTableCell_component_1 = __webpack_require__(35);
	exports.SuperTableCell = superTableCell_component_1.SuperTableCell;
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = {
	    directives: [superTable_component_1.SuperTable]
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var superTableHead_component_1 = __webpack_require__(3);
	var superTableBody_component_1 = __webpack_require__(29);
	var SuperTableState_1 = __webpack_require__(4);
	var SuperTable = (function () {
	    ...
	    SuperTable = __decorate([
	        core_1.Component({
	            ...
	            directives: [superTableHead_component_1.SuperTableHead, superTableBody_component_1.SuperTableBody],
	            styles: ["\n    :host {\n      position: relative;\n      display: block;\n    }\n    .loading-message {\n      text-align: center;\n    }\n  "],
	            providers: [SuperTableState_1.SuperTableState]
	        }), 
	        __metadata('design:paramtypes', [core_1.ElementRef, SuperTableState_1.SuperTableState])
	    ], SuperTable);
	    return SuperTable;
	}());
	exports.SuperTable = SuperTable;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(2);
	var SuperTableState_1 = __webpack_require__(4);
	var tableHeader_component_1 = __webpack_require__(25);
	var textFilter_component_1 = __webpack_require__(26);
	var enumFilter_component_1 = __webpack_require__(28);
	var SuperTableHead = (function () {
	    ...
	    SuperTableHead = __decorate([
	        core_1.Component({
	            ...
	            directives: [tableHeader_component_1.TableHeader, textFilter_component_1.TextFilter, enumFilter_component_1.EnumFilter],
	        ...
	        __metadata('design:paramtypes', [SuperTableState_1.SuperTableState])
	    ], SuperTableHead);
	    return SuperTableHead;
	}());
	exports.SuperTableHead = SuperTableHead;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(2);
	var BehaviorSubject_1 = __webpack_require__(5);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(2);
	var SuperTableState_1 = __webpack_require__(4);
	var SORT_TITLE = 'Click to change sort order. Shift-click to sort on multiple columns.';
	var Resizer = (function () {
	    ...
	    Resizer.prototype.grab = function (grabEvt) {
	        ...
	        var drag = function (event) {
	            ...
	            _this.column.width = Math.max(initWidth + change, Resizer.MIN_COLUMN_WIDTH);
	        };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TextFilter = (function () {
	    function TextFilter(state) {
	        this.state = state;
	        this.onModelChange = _.debounce(function () {
	            this.state.notify();
	        }, 200);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EnumFilterDropdown = (function () {
	    ...
	    EnumFilterDropdown.prototype.showAll = function () {
	        var _this = this;
	        _.forEach(this.column.filterValue, function (val, key) {
	    ...
	    EnumFilterDropdown = __decorate([
	        ...
	        __metadata('design:paramtypes', [SuperTableState_1.SuperTableState, core_1.ElementRef])
	    ], EnumFilterDropdown);
	...
	var EnumFilter = (function () {
	    ...
	    EnumFilter.prototype.ngOnInit = function () {
	        ...
	        this.subscription = this.state.stateChanged$.subscribe(function () {
	            _this.disabledFilterCount = _.values(_this.column.filterValue)
	    ...
	    EnumFilter.prototype.toggleVisibility = function () {
	        ...
	        if (this.dropdown) {
	            ...
	            var clientRect_1 = this.el.nativeElement.getBoundingClientRect();
	            this.resolver
	                .resolveComponent(EnumFilterDropdown)
	                .then(function (cmpFactory) {
	                var ctxInjector = _this.viewContainer.injector;
	                var cmpRef = _this.viewContainer.createComponent(cmpFactory, 0, ctxInjector);
	                cmpRef.instance.column = _this.column;
	                cmpRef.instance.top = clientRect_1.top + clientRect_1.height;
	                cmpRef.instance.left = clientRect_1.left;
	                cmpRef.instance.width = clientRect_1.width;
	    ...
	    EnumFilter = __decorate([
	        ...
	        __metadata('design:paramtypes', [SuperTableState_1.SuperTableState, core_1.ElementRef, core_1.ViewContainerRef, core_1.ComponentResolver])
	    ], EnumFilter);
	    return EnumFilter;
	}());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(2);
	var SuperTableState_1 = __webpack_require__(4);
	var superTableRow_component_1 = __webpack_require__(30);
	var tableHeader_component_1 = __webpack_require__(25);
	var dummyRows_component_1 = __webpack_require__(32);
	var _ = __webpack_require__(27);
	...
	var SuperTableBody = (function () {
	    function SuperTableBody(el, state) {
	        ...
	        this.rowOffset = 0;
	        this.trackScroll = _.debounce(function () {
	    ...
	    SuperTableBody.prototype.ngOnInit = function () {
	        window.addEventListener('resize', this.onWindowResize);
	    };
	    SuperTableBody.prototype.ngOnDestroy = function () {
	    ...
	    SuperTableBody = __decorate([
	        core_1.Component({
	            ...
	            directives: [superTableRow_component_1.SuperTableRow, dummyRows_component_1.DummyRows, tableHeader_component_1.TableHeader],
	...
	exports.SuperTableBody = SuperTableBody;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(2);
	var SuperTableState_1 = __webpack_require__(4);
	var tableCell_component_1 = __webpack_require__(31);
	var SuperTableRow = (function () {
	    ...
	    SuperTableRow = __decorate([
	        core_1.Component({
	            ...
	            directives: [tableCell_component_1.TableCell]
	        }), 
	        __metadata('design:paramtypes', [SuperTableState_1.SuperTableState])
	    ], SuperTableRow);
	    return SuperTableRow;
	}());
	exports.SuperTableRow = SuperTableRow;
	    ...
	    TableCell.prototype.ngOnInit = function () {
	        ...
	        if (this.column.def.component) {
	            this.resolver
	                ...
	                .then(function (cmpFactory) {
	                var ctxInjector = _this.cmpContainer.injector;
	                var cmpRef = _this.cmpContainer.createComponent(cmpFactory, 0, ctxInjector);
	                var instance = cmpRef.instance;
	                instance['row'] = _this.row;
	                instance['column'] = _this.column;
	                instance['key'] = _this.column.def.key;
	                instance['value'] = _this.getValue();
	                return cmpRef;
	            });
	        }
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.SuperTableCell = SuperTableCell;
...
;
//# sourceMappingURL=ng2-super-table.js.map